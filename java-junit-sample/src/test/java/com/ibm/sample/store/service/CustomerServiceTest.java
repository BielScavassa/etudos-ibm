...
import com.ibm.sample.store.service.external.AddressService;
import com.ibm.sample.store.service.external.HostService;
...
public class CustomerServiceTest {
    ...
    public void testExpand() {
    	...
    	int a = 10;
    	//WHEN
    	when(hostService.expand(any(Customer.class))).thenReturn(a);
    	//THEN
    	assertEquals(10, a);
    }
